...
const { Availability, Appointment } = models; // Add Appointment to the destructuring
...
const getAvailability = async (req, res) => {
  try {
    ...
    return res.sendStatus(500) // Fixed: was 5000, should be 500
  }
}
...
export {
  getAvailability,
  setAvailability,
  getAvailableSlots  // ADD THIS TO EXPORTS
} 